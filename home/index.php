<?php include '../layouts/header.php'; ?>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-xl-6 col-md-6 mb-6 mb-2" onclick="window.location.href='../patients/index.php'">
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Patients</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800">Patients Center</div>
                    </div>
                    <div class="col-auto">
            ...
            <!-- Doctors -->
            <div class="col-xl-6 col-md-6 mb-6 mb-2" onclick="window.location.href='../doctors/index.php'">
